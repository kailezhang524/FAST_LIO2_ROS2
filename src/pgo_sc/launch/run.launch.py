...
def generate_launch_description():
    ...
    mapping_file_path =os.path.join(get_package_share_directory('fast_livo'), 'launch', 'mapping_mid360s.launch.py')
    ...
    odom_topic_arg = DeclareLaunchArgument('odom_topic', default_value='/aft_mapped_to_init')
